    ...
    return (
        <div className="flex flex-grow justify-center mt-[10vh]">
            <div className="hidden sm:flex flex-row w-full mx-2 h-full mb-2">
                ...
                <div className="flex w-[80%] bg-[#2a2a2a] flex-col flex-wrap p-5 min gap-1" style={{ marginLeft: `max(calc(var(--spacing) * 60), 20%)`}}>
                    ...
                    <div className="grow flex flex-row flex-wrap xl:flex-nowrap justify-between gap-1">
                        ...
                        <div className="flex flex-col w-[100%] xl:grow h-full gap-1">
